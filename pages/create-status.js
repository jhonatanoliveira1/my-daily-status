...
const CreateStatus = (props) => {
    ...
    return (
        <div>
            ...
            <label className='block text-lg text-center m-8'>
            ...
            <button className='py-4 px-2 rounded bg-pink-800 font-bold shadow-xl hover:shadow block w-1/4 text-center mx-auto text-white' onClick={ getMyLocation }>
                Pegar minha localização
            </button>
            <p className='text-3xl text-center m-8'>
                Sua posição atual:{ dados.coords.lat } {dados.coords.long} 
            </p>
            <button className='py-4 px-2 rounded bg-pink-800 font-bold shadow-xl hover:shadow block w-1/4 text-center mx-auto text-white' onClick={ save }>
                Salvar meu status 
            </button>
        </div>
    );
